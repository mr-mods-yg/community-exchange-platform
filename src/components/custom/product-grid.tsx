        ...
        >
          ...
          <div className="flex flex-1 flex-col p-5">
            ...
            <div className="mb-4 flex items-start justify-between gap-4">
              <h3 className="line-clamp-2 text-xs md:text-lg font-bold text-white transition-colors group-hover:text-emerald-400">
                {product.name}
              </h3>
              <span className="shrink-0 text-xs md:text-lg font-bold text-transparent bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text">
                {product.price}
              </span>
            </div>
